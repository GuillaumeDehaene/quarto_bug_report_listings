...
This document shows a bugged listing: @lst-bugged-listing. For comparison, the listing should render as the other listing: @lst-normal.
...
```{#lst-normal .latex lst-cap="This listing is not bugged"}
